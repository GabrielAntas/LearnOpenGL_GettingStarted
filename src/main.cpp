...
int main()
{
    ...
    glUniform1i(glGetUniformLocation(ourShader.ID, "texture1"), 0); // manualne ustawienie
    ourShader.setInt("texture2", 1); // używając klasy shader
